...
# !!! Main.UserApp is configured as an alias for Main.ImageManip and you might encounter it in some tests
using Main.ImageManip, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "ImageManip tests" begin
  @includetests ARGS
end
